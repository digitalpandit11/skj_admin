...
<?php
    ...
    // $this->db->from('sales_order_product_relation');
    // $where = '(sales_order_product_relation.user_id = "'.$user_id.'" AND sales_order_product_relation.status = 1)';
    // $this->db->where($where);
    // $sales_order_register_data = $this->db->get();
    // $sales_order_register_count = $sales_order_register_data->num_rows();
            ...
            <!-- /.card -->
                  ...
                  <!-- <div class="col-md-4">
                    <ul class="chart-legend clearfix">
                      <li><i class="far fa-circle text-danger"></i> Indiamart</li>
                      <li><i class="far fa-circle text-success"></i> Excibition</li>
                      <li><i class="far fa-circle text-warning"></i> MID</li>
                      <li><i class="far fa-circle text-info"></i> Phone Call</li>
                      <li><i class="far fa-circle text-primary"></i> Direct Mail</li>
